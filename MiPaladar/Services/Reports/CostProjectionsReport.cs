...
{
    public class CostProjectionsReport : ProjectionsReport, ICostProjectionsRS
    {
        ...
        {
            return li.ProductType == ProductType.RawMaterials || li.ProductType == ProductType.CompraVenta;
        }

        protected override string ReportName
        {
            get { return "Proyecciones de costo"; }
        }
    }
}
