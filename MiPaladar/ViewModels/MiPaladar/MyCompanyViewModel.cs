...
namespace MiPaladar.ViewModels
{
    public class MyCompanyViewModel : ViewModelBase
    {
        ...
        public MyCompanyViewModel(MainWindowViewModel appvm)
        {
            this.appvm = appvm;
        ...
        public ICommand BrowseReportFolderCommand
        {
            get
            {
        ...
        void BrowseReportFolder()
        {
            ...
            if (folderBrowser.ShowDialog("Selecciona la carpeta donde quieres guardar los reportes") == true)
            {
        ...
        bool CanSave
        {
            get
            {
                return startingShiftAmount >= 0 && defaultTax >= 0 && !string.IsNullOrWhiteSpace(companyName) && IsValidIP(registerIP);
            }
        }
        ...
        void Save()
        {
            ...
            if (companyInfo.ReportsFolder != reportsFolder) companyInfo.ReportsFolder = reportsFolder;
            if (companyInfo.RegisterIP != registerIP) companyInfo.RegisterIP = registerIP;
        ...
        public ICommand CancelNetworkCommand
        {
            get
            {
