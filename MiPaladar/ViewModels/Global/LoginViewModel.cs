...
namespace MiPaladar.ViewModels
{
    ...
    {
        Action<Employee> onLoginSuccess;

        public LoginViewModel(Action<Employee> onLoginSuccess) 
        {
        ...
        void loginWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            switch (result)
            {
                ...
                case LoginResult.Success:
                    if (onLoginSuccess != null) onLoginSuccess(userEntered);
                    break;
                default:
                    break;
            }            
        ...
        LoginResult CheckLogin(string username, string password) 
        {
            ...
            userEntered = FindUserFromName(username);
        ...
        private Employee FindUserFromName(string username)
        {
            ...
            {
                var queryResult = from user in unitOfWork.EmployeeRepository.Get(x => x.Name == username, includeProperties: "Role")
