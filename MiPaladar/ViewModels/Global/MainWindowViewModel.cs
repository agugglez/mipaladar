...
namespace MiPaladar.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        void OnFirstLoginSuccess(Employee emp)
        {
            //RunLoaderWorker();
        ...
        ////    //var query = from p in context.Products.Include("Ingredients")
        ////    //            select p;
        ...
        //{
            ...
            //umManager = new UnitMeasureManager(this);
        ...
        //ObservableCollection<Tag> tagsOC;
        ...
        #region Create New Product Methods

        //public Product CreateProduct(int plu, string name, decimal price)
        //{
        ...
        //    prod.UMFamily = umManager.Quantity;
        //    prod.RecipeUnitMeasure = prod.CostUnitMeasure = umManager.Unit;
        ...
        //{
        //    tagsOC = new ObservableCollection<Tag>();
        ...
        //public ObservableCollection<Tag> TagsOC
        //{
        //    get { return tagsOC; }
        //}
...
//        ";
        ...
        GlobalEventsManager globalEvents;
        public GlobalEventsManager GlobalEventsManager
        {
            get
            {
                ...
                {
                    globalEvents = new GlobalEventsManager();
                }
                return globalEvents;
            }
        }
