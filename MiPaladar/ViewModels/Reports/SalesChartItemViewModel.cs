...
{
    public class SalesChartItemViewModel
    {
        public SalesChartItemViewModel() { }
        ...
        public SalesChartItemViewModel(Sale order)
        {
            Date = order.Date;
            ...
            {
                temp += ProductManager.GetCurrentCost(li.Product, li.Quantity, li.UnitMeasure);
            }
            TotalCost = temp;
